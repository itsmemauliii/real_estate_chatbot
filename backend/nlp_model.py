...
# Load property data at the module level
properties_df = load_properties_data(filepath='data/properties.csv')

# Intents for property search
intents_data = {
    ...
    "more_details": ["tell me more", "details", "info", "what about this property"],
...
def extract_entities(text):
    ...
    known_locations = ['mumbai', 'delhi', 'bangalore', 'pune', 'chennai', 'hyderabad', 'kolkata']
...
def get_property_recommendations(entities, df):
